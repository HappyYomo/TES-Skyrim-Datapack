#attacked
execute as @a run scoreboard players set @s a 10
...
execute as @a if score @s damage_taken matches 1.. run scoreboard players operation @s defense += 100 a
execute as @a if score @s damage_taken matches 1.. run scoreboard players operation @s defense /= 100 a
...
execute as @e[tag=ATK] at @s run scoreboard players operation @a[distance=..1,sort=nearest,limit=1] health_o *= 100 a
...
execute as @e[tag=ATK] at @s run scoreboard players operation @a[distance=..1,sort=nearest,limit=1] health /= 100 a
