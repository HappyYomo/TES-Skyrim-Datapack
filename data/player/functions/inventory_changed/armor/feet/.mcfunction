...
# 防御力増加
	execute if data storage tesv_whole: InventoryCopy[{Slot:100b}].tag.Defense store result score $Amount Temporary run data get storage tesv_whole: InventoryCopy[{Slot:100b}].tag.Defense
